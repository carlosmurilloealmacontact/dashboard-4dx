...
9. **Pausas 4DX** (compromisosCopilot): participación del equipo en las pausas 4DX de Diálogo y CDR. "pctDialogo"/"pctCDR" = % de pausas con participación (meta: 100%), "agentesConFaltaDialogo"/"agentesConFaltaCDR" = cantidad de asesores con al menos una pausa sin participación esa semana, "participacionPorDia" = lista de { dia, pctDialogo, pctCDR } con el % de participación de cada tipo de pausa por día hábil de la semana.
...
## Pausas 4DX
Formato estándar, basado en "pctDialogo" y "pctCDR" (participación en pausas de Diálogo y CDR) y "agentesConFaltaDialogo"/"agentesConFaltaCDR". Usa "participacionPorDia" para identificar si la baja participación se concentra en días específicos de la semana, y menciónalos como dato concreto cuando sea relevante para el foco (ej. "la participación en CDR cae particularmente los [día] para el equipo de [supervisor]"). Criterio de foco: "pctDialogo"/"pctCDR" por debajo de meta o asesores con faltas — pide ayuda para reforzar la participación en esas pausas con el equipo correspondiente. Si "compromisosCopilot" es null, formúlalo como novedad a validar.
