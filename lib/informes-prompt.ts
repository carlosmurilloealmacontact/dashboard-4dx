...
## Agenda del líder
Formato estándar, basado en "pct" de cumplimiento de agenda diaria y, si está disponible, "cdr". Criterio de foco: "pct" bajo. Si el cumplimiento es bajo, recuerda la importancia de sostener la agenda diaria como base de la gestión 4DX ("recordemos sostener la agenda diaria con el equipo de [supervisor], es la base para identificar focos a tiempo"). Si "agendaLider" es null, formúlalo como novedad a validar.
