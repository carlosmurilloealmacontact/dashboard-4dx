...
export const authOptions: NextAuthOptions = {
  providers: [
    GoogleProvider({
      ...
      authorization: {
        params: {
          scope: "openid email profile https://www.googleapis.com/auth/spreadsheets.readonly https://www.googleapis.com/auth/drive.metadata.readonly https://www.googleapis.com/auth/gmail.send",
          access_type: "offline",
